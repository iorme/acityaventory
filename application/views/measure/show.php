...
<script type="text/javascript" src="{{base_url()}}javascript/form_js/measure_delete.js"></script>
{{validation_errors()}}
...
<table style="width:600px; border:1px solid;">
 ...
 @foreach ($query as $row)
 	...
 	<tr class="record">
 		...
 		<td style="border:1px solid;"><a class="editbutton" id="{{$row->id}}" name="{{$row->name}}" desc="{{$row->desc}}" href="#">Edit</a></td>
